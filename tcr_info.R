...
fasta_name <- paste(experiment_name, "fullyproductiveTCR_trv_cdr3", sep = "_")
...
colnames(tcr_a_contig2)[2:12] <- paste("alpha_ctg2", colnames(tcr_a_contig2)[2:12], sep = "_")
colnames(tcr_a_contig1)[2:12] <- paste("alpha_ctg1", colnames(tcr_a_contig1)[2:12], sep = "_")
...
colnames(tcr_b_contig1)[2:13] <- paste("beta_ctg1", colnames(tcr_b_contig1)[2:13], sep = "_")   
colnames(tcr_b_contig2)[2:13] <- paste("beta_ctg2", colnames(tcr_b_contig2)[2:13], sep = "_")   
...
saveRDS(clono_seurat, "seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering_fullTCRinfo_productiveonly.Rds")
