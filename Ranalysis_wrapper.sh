...
#Rscript $1/make_seurat_rna_adt_hto_noProjwSpleen.R $project_description GEX/filtered_feature_bc_matrix FBC/filtered_feature_bc_matrix $2 $spleen  > make_seurat_rna_adt_hto.log 2> make_seurat_rna_adt_hto.err 
