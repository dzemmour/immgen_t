...
spleen=spleen.txt
getspleen=spleen.txt

# CellRanger Pipeline
#echo "Running cellranger mkfastq"
#cellranger mkfastq --id=fastqs --run=/n/groups/cbdm_lab//scRNAseq/BroadRun220505/220429_SL-NVL_0704_AHWVLMDRXY --csv=$layoutfile
...
#Rscript $1/filter.R combined_sample/outs/raw_feature_bc_matrix combined_sample/outs/filtered_feature_bc_matrix $2 $IGT > filter.log 2> filter.err
...
Rscript $1/get_spleen.R $project_description GEX/filtered_feature_bc_matrix FBC/filtered_feature_bc_matrix $2 $getspleen > spleen.log 2> spleen.err
Rscript $1/naming_samples_spleen.R spleen.Rds $2 $IGT
