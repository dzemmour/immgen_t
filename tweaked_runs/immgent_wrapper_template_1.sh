...
# Run as sbatch /n/groups/cbdm_lab/immgen_t/immgent_wrapper_template.sh /n/grou$
...
cellranger mkfastq --id=fastqs --run=/n/groups/cbdm_lab/scRNAseq/BroadRun220505/220408_SL-NVT_0448_BHWVTTDRXY --csv=$layoutfile --barcode-mismatches=2
...
#Rscript $1/filter.R combined_sample/outs/raw_feature_bc_matrix combined_sample/outs/filtered_feature_bc_matrix $2 $IGT
...
#Rscript $1/Tcell_filt_part1.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering.Rds $genelist $spleen
...
Rscript $1/Tcell_filt_part2_IGT31.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering.Rds $T_cutoffs $IGT $spleen  > T2.log 2> T2.err

Rscript $1/dietSeurat.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering_postTfiltering.Rds seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering.Rds $2 $IGT > diet.log 2> diet.err
