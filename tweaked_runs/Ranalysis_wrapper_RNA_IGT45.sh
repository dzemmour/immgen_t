...
Rscript $1/Tcell_filt_part1_RNA.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR.Rds $genelist > T1.log 2> T1.err
...
Rscript $1/Tcell_filt_part2_RNA.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR.Rds $T_cutoffs $IGT $spleen  > T2.log 2> T2.err
