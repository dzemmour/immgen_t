...
#Rscript $1/make_seurat_rna_adt_hto_noProj.R $project_description GEX/filtered_feature_bc_matrix FBC/filtered_feature_bc_matrix $hashes_to_remove > make_seurat_rna_adt_hto.log 2> make_seurat_rna_adt_hto.err
...
Rscript $1/Tcell_filt_part2.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering.Rds seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering_fullTCRinfo_productiveonly.Rds $T_cutoffs $IGT  > T2.log 2> T2.err
