...
#cellranger mkfastq --id=fastqs --run=/n/groups/cbdm_lab/scRNAseq/BroadRun230413/230412_SL-NVD_1143_BHJNLHDMXY --csv=$layoutfile
...
cellranger vdj --id=TCR_IMGT \
                 --reference=/n/groups/cbdm_lab/scRNAseq/files/vdj_IMGT_B6_ref \
                 --fastqs=fastqs/outs/fastq_path,/n/groups/cbdm_lab/scRNAseq/BroadRun220720/IGT10/220715_SL-NVD_0998_AHFVLVDRX2/fastqs/outs/fastq_path \
                 --sample=TCR,TCR2
...
#Rscript $1/adt_qc.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR.Rds $adt_hash_seqs 3000 2 > adt_qc.log 2> adt_qc.err
