...
#cellranger mkfastq --id=fastqs --run=/n/groups/cbdm_lab/scRNAseq/BroadRun230602/ --csv=$layoutfile
...
#cellranger vdj --id=TCR \
 #                --reference=/n/groups/cbdm_lab/scRNAseq/files/refdata-cellranger-vdj-GRCm38-alts-ensembl-7.0.0 \
...
#Rscript $1/Tcell_filt_part1.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR.Rds $genelist

#Rscript $1/naming_samples.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR.Rds $2 
...
#Rscript $1/Tcell_filt_part2_IGT46.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR.Rds $T_cutoffs $IGT $spleen  > T2.log 2> T2.err
