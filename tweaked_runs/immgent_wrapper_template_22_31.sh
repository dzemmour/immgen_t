...
#Rscript $1/Tcell_filt_part2.R seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering.Rds seuratobject_withHTOADT_singlet_postRNAfiltering_withSingleR_postADTfiltering_fullTCRinfo_productiveonly.Rds $T_cutoffs $IGT
