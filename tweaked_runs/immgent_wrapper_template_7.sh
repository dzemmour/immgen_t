...
#cellranger mkfastq --id=fastqs_TCR --run=/n/groups/cbdm_lab/immgen_t_Data/221204_SL-NVH_0481_BHH3T2DMXY/221204_SL-NVH_0481_BHH3T2DMXY --csv=$layoutfile
...
#cellranger vdj --id=TCR \
 #                --reference=/n/groups/cbdm_lab/bv43/refdata-cellranger-vdj-GRCm38-alts-ensembl-5.0.0 \
  #               --fastqs=fastqs_TCR/outs/fastq_path/ \
   #              --sample=TCR
