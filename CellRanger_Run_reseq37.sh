...
#cellranger mkfastq --id=fastqs --run=/n/groups/cbdm_lab/scRNAseq/BroadRun240404/TCR/1712237850/ --csv=$layoutfile
...
#cellranger count  --id=combined_sample \
                  ...
                  #--transcriptome=/n/groups/cbdm_lab/scRNAseq/files/M25/M25/M25 \
                  #--expect-cells=100000
...
cellranger vdj --id=TCR \
                 ...
                 --fastqs=fastqs/outs/fastq_path/,/n/groups/cbdm_lab/scRNAseq/BroadRun230413/230412_SL-NVD_1143_BHJNLHDMXY/IGT37/fastqs/outs/fastq_path/ \
                 --sample=VDJ
